...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Nahid") || (event.body.toLowerCase() == "Nahid bai") || (event.body.toLowerCase() == "@Nahid ッ") || (event.body.toLowerCase() == "নাহিদ")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:NA'HID ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস নাহিদ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
